...
for font_path in (base / "test_fonts").glob("*.[ot]tf"):
    with open(font_path, "rb") as font_file:
        font_file_read = font_file.read()
        test_fonts_data.append((font_file_read, font_path))


@pytest.mark.parametrize("font_file_read, font_path", test_fonts_data)
def test_post_rotorizer(client, font_file_read, font_path):
...
@pytest.mark.parametrize("font_file_read, font_path", test_fonts_data)
def test_post_rasterizer(client, font_file_read, font_path):
...
@pytest.mark.parametrize("font_file_read, font_path", test_fonts_data)
def test_post_pan(client, font_file_read, font_path):
